        ...
        try {
            ...
            **/
            ...
            if (entry == null) {
                ...
                if (entry == null) {
                    entry = zipFile.getEntry("libs/" + folder + "/" + libName);
                    if (entry == null) {
                        entry = zipFile.getEntry("libs/" + folder + "/" + libName + ".so");
                        if (entry == null) {
                            throw new Exception("NativeLoader: Unable to find file in apk:" + "lib/" + folder + "/" + libName);
                        }
                    }
                }
            }
