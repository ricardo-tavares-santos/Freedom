...
package com.RWTech.Freedom.service.vpn;
...
public class OrbotVpnManager implements Handler.Callback {
    ...
    private String mSessionName = "Freedom VPN";
    ...
    public int handleIntent(Builder builder, Intent intent) {
    	...
    	if (intent != null)
    	{
	    	...
	    	{
	    		Log.d(TAG,"stop FreedomVPNService service!");
	    		
	    		stopVPN();
	    	}
	    	else if (action.equals(TorServiceConstants.LOCAL_ACTION_PORTS))
			{
				Log.d(TAG,"starting FreedomVPNService service!");
    	...
    	mThreadVPN = new Thread ()
    	{
    		...
    		public void run ()
    		{
	    		try
		        {
		    		...
		    		final String vpnName = "FreedomVPN";
